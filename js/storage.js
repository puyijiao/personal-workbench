...
const Store = {
  ...
  initDefaults() {
    ...
    const defaults = {
      ...
      foodLib: [],
      foodPairs: [
        { a: '番茄', b: '橄榄油', tip: '番茄红素是脂溶性的，配橄榄油或炒鸡蛋吸收率翻倍' },
        { a: '菠菜', b: '鸡蛋', tip: '菠菜的植物铁 + 鸡蛋的动物蛋白，补铁效果更好' },
        { a: '鸡蛋', b: '番茄', tip: '经典搭配，番茄红素 + 优质蛋白，对皮肤和眼睛都好' },
        { a: '三文鱼', b: '西兰花', tip: '深海鱼Omega-3 + 西兰花抗炎，护眼又养胃' },
        { a: '燕麦', b: '牛奶', tip: '燕麦可溶纤维 + 牛奶钙质，早餐黄金组合' },
        { a: '豆腐', b: '海带', tip: '豆腐补钙 + 海带碘，还促进营养吸收' },
        { a: '红枣', b: '小米', tip: '小米养胃 + 红枣补气血，温和好消化' },
        { a: '山药', b: '南瓜', tip: '都是健脾养胃食材，蒸煮一起吃很温和' },
        { a: '蓝莓', b: '酸奶', tip: '蓝莓花青素 + 酸奶益生菌，护眼助消化' },
        { a: '胡萝卜', b: '鸡蛋', tip: '胡萝卜β胡萝卜素 + 鸡蛋，脂溶吸收更好' },
        { a: '姜茶', b: '红枣', tip: '姜驱寒 + 红枣补气血，上午喝最好' },
        { a: '羊肉', b: '白萝卜', tip: '羊肉温补 + 白萝卜去膻助消化，秋冬很搭' },
        { a: '冬瓜', b: '薏米', tip: '祛湿组合，舌苔厚腻时适合' },
        { a: '黑木耳', b: '鸡蛋', tip: '木耳补铁 + 鸡蛋蛋白质，营养互补' },
        { a: '黄瓜', b: '鸡蛋', tip: '清淡低脂组合，减脂期友好' }
      ],
